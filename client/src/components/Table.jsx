  ...
  const TableHeader = () => (
    <thead className="w-full border-b border-gray-300 dark:border-gray-600">
      <tr className="w-full text-black dark:text-white  text-left">
        ...
        <th className="py-2 line-clamp-1">Fecha de Creación</th>
  ...
  const TableRow = ({ task }) => (
    <tr className="border-b border-gray-200 text-gray-600 hover:bg-gray-300/10">
      ...
      <td className="py-2 flex gap-2 md:gap-4 justify-end">
        <Button
          className="text-blue-600 hover:text-blue-500 sm:px-0 text-sm md:text-base flex items-center justify-center gap-1"
          label={
            <>
              <FiEdit />
              Editar
        ...
        <Button
          className="text-red-700 hover:text-red-500 sm:px-0 text-sm md:text-base flex items-center justify-center gap-1"
          label={
            <>
              <FiTrash2 />
              Eliminar
