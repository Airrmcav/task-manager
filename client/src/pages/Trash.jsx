...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("¿Desea eliminar permanentemente todos los items?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("¿Desea restaurar el item seleccionado?");
    setOpenDialog(true);
  };
    ...
    <>
      <div className='w-full md:px-1 px-0 mb-6'>
        <div className='flex items-center justify-between mb-8'>
          <Title title='Tareas en la Papelera' />
        ...
        {data?.tasks?.length > 0 ? (
          ...
          <div className='w-full flex justify-center py-10'>
            <p className='text-lg text-gray-500'>No hay Tarea en la Papelera</p>
          </div>
        )}
      </div>
